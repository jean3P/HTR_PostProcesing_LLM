# repos/HTR_PostProcesing_LLM/LLMs/src/prompts/openrouter/methods/OpenRouterTextProcessingPromptOR3.py
...
class OpenRouterTextProcessingPromptOR3(OpenRouterProcessingStrategy):
    """
    PromptOR 3: Extended guidelines with punctuation and hyphenation rules
    """
    ...
    def check_and_correct_text_line(self, text_line, train_set_lines, llm_instance, name_dataset, logger):
        logger.info(
            f"Start processing text line with PromptOR 3: '{text_line}' -- from {get_time(name_dataset)}-century")
    ...
    def correct_with_prompts(
        ...
        # PromptOR 3: Extended version with more guidelines
        system_prompt = (
            ...
            f"4. If the original text line is hyphenated, the hyphen must be retained.\n"
