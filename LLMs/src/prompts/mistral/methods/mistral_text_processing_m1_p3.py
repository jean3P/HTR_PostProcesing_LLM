...
class MistralTextProcessingM1P3(TextProcessingStrategy):
    def __init__(self):
    ...
    def check_and_correct_text_line(self, text_line,  pipe, tokenizer, train_set_lines, name_dataset, logger, terminators=None):
