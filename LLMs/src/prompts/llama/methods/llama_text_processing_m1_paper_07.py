...
class LlamaTextProcessingM1P07(TextProcessingStrategy):
    def __init__(self):
    ...
    def correct_with_suggestions(self, ocr_text, suggestions, pipe, tokenizer, name_dataset, terminators, logger):
        ...
        response = calculate_pipe_llama(pipe, system_prompt, tokens_prompt, terminators, 0.7)
