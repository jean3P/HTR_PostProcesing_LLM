...
class GptTextProcessingM1P1(TextProcessingStrategy):
    ...
    def correct_with_suggestions(self, ocr_text, suggestions, model_name, openai_token, llm_name_2, logger):
        ...
        system_prompt = (
            f"Your task is to correct OCR errors. Please analyze the following text line and provide "
            f"the corrected version: {ocr_text}"
