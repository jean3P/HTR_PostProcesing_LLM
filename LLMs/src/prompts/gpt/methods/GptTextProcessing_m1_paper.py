# ./prompts/gpt/methods/GptTextProcessing_m1_paper.py

import re
import time

from prompts.gpt.GPTProcessingStrategy import TextProcessingStrategy
from utils.aux_processing import suggest_corrections_for_ocr_text_m1, count_tokens_gpt, calculate_pipe_openai, clean_text, get_time


class GptTextProcessingM1_V1(TextProcessingStrategy):
    ...
    def check_and_correct_text_line(self, text_line, train_set_lines, model_name, openai_token, llm_name_2, name_dataset, logger):
        ...
        corrected_text = self.correct_with_suggestions(text_line, suggestions, model_name, openai_token, name_dataset,
                                                       llm_name_2, logger)
    ...
    def correct_with_suggestions(self, ocr_text, suggestions, model_name, openai_token, name_dataset, llm_name_2, logger):
        suggestion_part = "\n".join(
        ...
        system_prompt = (
            ...
            f"\n\n## Guidelines:"
            f"\n1. Ensure corrections accurately reflect the {get_time(name_dataset)}-century language and conventions"
    ...
    def evaluate_corrected_text(self, original_text_line, corrected_text_line, model_name, openai_token, llm_name_2,
                                logger):
