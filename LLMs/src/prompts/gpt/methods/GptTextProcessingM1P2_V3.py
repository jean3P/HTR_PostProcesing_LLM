...
class GptTextProcessingM1P2_V3(TextProcessingStrategy):

    def __init__(self):
        self.suggestions_memory = {}

    def get_name_method(self):
        return "method_1_V3_F"
    ...
    def correct_with_suggestions(self, ocr_text, suggestions, model_name, openai_token, name_dataset, llm_name_2, logger):
        ...
        system_prompt = (
            f"Act as an 18th-century document analyst specializing in OCR correction. Your task is to correct "
            f"OCR errors in words or numbers."
            f"\n\n## Guidelines:"
            ...
            f"\nBased on the guidelines, please analyze the following text line and provide the corrected "
            f"version: {ocr_text}"
